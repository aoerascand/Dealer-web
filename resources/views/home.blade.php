...
<div class="bg-gradient-to-r from-slate-900 to-blue-900 rounded-2xl shadow-2xl overflow-hidden mb-12">
    <div class="px-8 py-16 md:px-16 text-center md:text-left md:flex justify-between items-center text-white">
        ...
        <div class="md:w-1/2">
            ...
            <a href="/kategori" class="bg-white text-blue-900 hover:bg-blue-50 font-bold px-8 py-3.5 rounded-full shadow-lg transition-transform transform active:scale-95 inline-block">
                Lihat Katalog
            </a>
        </div>
