...
<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 md:p-12 max-w-5xl mx-auto my-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-start">
                <div class="flex-shrink-0 bg-green-100 p-3 rounded-full text-green-900">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-slate-600 mt-1"><a href="https://instagram.com/dealermotor_id" target="_blank" class="hover:text-green-600">@dealermotor_id</a></p>
                </div>
            </div>
